...
- Phase 4 complete: NEWS.md `# mc 0.2.9` entry covering primitive + flag + default + case-insensitive system fix. Version bumped 0.2.8 → 0.2.9. Docs already updated inline in Phases 2–3. Full suite 302 pass / 0 fail. Lint clean for changed files.
